...
class ImagePreloader {
    ...
    setImageList() {
        this.images = [
            ...
            // Avatares
            '/img/avatar/avatar-opponent.png',
            '/img/avatar/avatar-player.png',
            // Background
            ...
            // Monstros
            '/img/monstros/AGA-1-Aquavor.png',
            '/img/monstros/AGA-1-Tydrill.png',
            '/img/monstros/AGA-2-Hidralisk.png',
            '/img/monstros/AGA-2-Rainscour.png',
            '/img/monstros/AGA-3-Ocearion.png',
            '/img/monstros/ELT-1-Thundril.png',
            '/img/monstros/ELT-1-Voltrik.png',
            '/img/monstros/ELT-2-Joltriss.png',
            '/img/monstros/ELT-2-Sparkon.png',
            '/img/monstros/ELT-3-Zaptron.png',
            '/img/monstros/ELT-3-Zaptron.png',
            '/img/monstros/FGO-1-Ashgrim.png',
            '/img/monstros/FGO-1-Volkris.png',
            '/img/monstros/FGO-2-Pyrrak.png',
            '/img/monstros/FGO-3-Flarehorn.png',
            '/img/monstros/FGO-3-Scaldrix.png',
            '/img/monstros/TER-1-Mudrak.png',
            '/img/monstros/TER-1-Oritur.png',
            '/img/monstros/TER-2-Crustorr.png',
            '/img/monstros/TER-2-Terradom.png',
            '/img/monstros/TER-3-Quakmor.png',
            //transições
            '/img/transicao/PORTA1A.png',
            '/img/transicao/PORTA1B.png',
            '/img/transicao/PORTA2.png',
            '/img/transicao/PORTA3.png',
        ];
